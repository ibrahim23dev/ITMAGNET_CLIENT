      ...
      <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
        <div className="space-y-8">
              ...
              <div className="space-y-4">
                 {[
                   ...
                   { icon: <Bell className="h-4 w-4" />, title: "Notification Sync", desc: "Configure how you receive ticket alerts." },
                    ...
                    <div key={i} className="group flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-950 transition-colors cursor-pointer border border-transparent hover:border-slate-100 dark:hover:border-slate-800">
                       <div className="flex items-center gap-4">
                          <div className="h-10 w-10 bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 group-hover:text-primary transition-colors">
                             {item.icon}
                          </div>
                          <div>
           ...
           <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 p-8">
              ...
              <div className="p-6 bg-primary/5 border border-primary/10 mb-6">
                 <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-bold uppercase tracking-widest text-primary">RAG Auto-Indexing</span>
                    <div className="h-5 w-10 bg-primary relative px-1 flex items-center">
                       <div className="h-3 w-3 bg-white absolute right-1"></div>
                    </div>
                 </div>
        ...
        <div className="space-y-8">
           ...
           <div className="p-8 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800">
              ...
              <Button variant="outline" className="w-full mt-8 h-12 border-slate-200 dark:border-slate-800 font-bold">
                 Manage Plan
              </Button>
           </div>
        </div>
